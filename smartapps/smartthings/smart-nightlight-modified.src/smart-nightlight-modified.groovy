 ...
 */
definition(
    name: "Smart Nightlight Modified",
    namespace: "smartthings",
    author: "SmartThings",
    description: "Turns on lights when between sunset and sunrise and motion is detected. Turns lights off some time after motion ceases.",
